CREATE TABLE IF NOT EXISTS FPA_FOD_PLUS(
  ...
  ,GACC_PL                       INTEGER DEFAULT -1
  ,GACC_New_fire                 INTEGER DEFAULT -1
  ,GACC_New_LF                   INTEGER DEFAULT -1
  ,GACC_Uncont_LF                INTEGER DEFAULT -1
  ,GACC_Type_1_IMTs              INTEGER DEFAULT -1
  ,GACC_Type_2_IMTs              INTEGER DEFAULT -1
  ,GACC_NIMO_Teams               INTEGER DEFAULT -1
  ,GACC_Area_Command_Teams       INTEGER DEFAULT -1
