"""
Django settings for ffp-backend project.
...
SECRET_KEY = 'django-insecure-@-iius16of+@5pwvkgv3uq!e7f6bktpz(vd!6#u7mnnd+$!e0j'
...
WSGI_APPLICATION = 'ffp-backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('MYSQL_DATABASE_HOST', 'ffp-mysql'),
...
# TODO: Should this only be local
